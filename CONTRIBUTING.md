...
1. Confirm the build is [passing in travis](https://travis-ci.org/AladinWay/TransitionButton)
...
2. Push a release commit
   ...
   2. Rename the old Master section like:
          ## [1.0.5](https://github.com/aladinway/TransitionButton/releases/tag/1.0.5)
...
4. Create Carthage binaries
   ...
   2. `carthage archive TransitionButton`
